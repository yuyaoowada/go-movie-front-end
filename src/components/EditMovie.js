...
const EditMovie = () => {
  ...
  const handleSubmit = (event) => {
    ...
    let errors = [];
    let requied = [
      { filed: movie.title, name: "title" },
      { filed: movie.release_date, name: "release_date" },
      { filed: movie.runtime, name: "runtime" },
      { filed: movie.description, name: "description" },
      { filed: movie.mpaa_rating, name: "mpaa_rating" },
    ];

    requied.forEach(function (obj) {
      if (obj.filed === "") {
    ...
    requestBody.release_date = date.toISOString().split("T")[0];
